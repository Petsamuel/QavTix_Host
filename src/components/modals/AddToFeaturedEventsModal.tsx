...
export default function AddToFeaturedModal({ isOpen, onClose, eventId }: { isOpen: boolean, onClose: () => void, eventId: string }) {
    ...
    const handleProceed = async () => {
        await promoteToFeatured(eventId)
    }
    ...
    return (
        <>
            ...
            >
                <div className="text-center bg-brand-neutral-1/30">
                    ...
                    <DialogDescription className="text-xs text-brand-neutral-7 mt-1 px-6 leading-relaxed">
                ...
                <div className="p-6 bg-brand-neutral-1/50 border-t border-brand-neutral-2 flex flex-col gap-3">
                    <ActionButton1 
